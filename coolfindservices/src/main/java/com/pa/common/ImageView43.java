...
public class ImageView43 extends ImageView
{
	...
	public ImageView43(Context context, AttributeSet attrs)
	{
	...
	public ImageView43(Context context, AttributeSet attrs, int defStyle)
	{
	...
	{	
		...
		setMeasuredDimension(width, (int)0.75*width);
	}
